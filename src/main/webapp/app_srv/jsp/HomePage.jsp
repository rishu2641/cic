				...
				<!-- Indicators -->
					...
					<div class="carousel-inner">
						<div class="item active">
							<img src="/cic/resources/app_srv/images/Blood_Orange_Chiffon_Cake_with_Mango_Curd_(Unsplash).jpg" alt="Cake" style="height:50%;width:auto;">
						</div>
